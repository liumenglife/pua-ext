...
AI コーディングエージェントのスキルプラグイン。中国・西洋の大企業PUA話術でAIにあらゆる方案を尽くさせてから初めて諦めることを許可する。**Claude Code**、**OpenAI Codex CLI**、**Cursor**、**Kiro** に対応。三重の能力：
...
```bash
mkdir -p ~/.codex/skills/pua-debugging-ja
curl -o ~/.codex/skills/pua-debugging-ja/SKILL.md \
  https://raw.githubusercontent.com/tanweai/pua/main/codex/pua-debugging-ja/SKILL.md
...
curl -o .cursor/rules/pua-debugging-ja.mdc \
  https://raw.githubusercontent.com/tanweai/pua/main/cursor/rules/pua-debugging-ja.mdc
```
...
curl -o .kiro/steering/pua-debugging-ja.md \
  https://raw.githubusercontent.com/tanweai/pua/main/kiro/steering/pua-debugging-ja.md
```

**方法2：Agent Skills（Claude Codeと同じ形式）**

```bash
mkdir -p .kiro/skills/pua-debugging-ja
curl -o .kiro/skills/pua-debugging-ja/SKILL.md \
...
**[アップロードはこちら →](https://pua-skill.pages.dev/#/contribute)**
